...
import { Backdrop, Box, Portal, Stack, Typography } from "@mui/material";
import { useI18n } from "../../i18n/I18nProvider";
import { localFileUrl } from "../../lib/external-url";
import { IconButton } from "./IconButton";

/** Full-screen image viewer opened from thumbnails or message attachments. */
export function ImageLightbox({ src, label, onClose }: { readonly src: string | null; readonly label?: string; readonly onClose: () => void }) {
  ...
  return (
    <Portal>
      ...
      >
        {src != null && (
          // The lightbox is portalled to avoid transformed chat-message wrappers
          // constraining fixed positioning to the message box instead of viewport.
          <Stack sx={{ width: "100vw", height: "100dvh", p: { xs: 1.5, sm: 3 }, minHeight: 0 }}>
